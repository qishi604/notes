...
### 2. class to dex
`dx` 位于 `android-sdk\build-tools\`

```
java -jar dx.jar --dex --output=filename.dex filename.class
```

### 3. dex to smali
```
baksmali disassemble app.apk/file.class -o .
```
...
java -jar dx.jar --dex --output=Logs.dex xxx.class

java -jar baksmali.jar disassemble xxx.dex
```
